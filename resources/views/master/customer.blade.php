	...
	<div class="modal fade" id="edit-{{$p->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="{{url('/update/customer/'.$p->id)}}" method="post">
				<div class="modal-body">
					@csrf
					<div class="mb-3 row">
						<label for="inputPassword" class="col-sm-2 col-form-label">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="name_customer" value="{{$p->name_customer}}">
						</div>
					</div>
				</div>
				<div class="modal-footer">
