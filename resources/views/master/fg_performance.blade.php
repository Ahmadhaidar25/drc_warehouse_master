...
<div style="margin-top: 150px;">
	<h2 class="text-center">FG PERFORMANCE SCAN QR&nbsp;<i class="bi bi-qr-code-scan"></i></h2>
	<div class="card">
		<div class="table-responsive">
			<div class="card-body">
				...
				<div role="group" style="float: right;">
					<a href="{{url('/cetak/pdf/fg')}}" class="btn btn-danger">
						<i class="bi bi-filetype-pdf"></i>&nbsp;Print
					</a>
					<a href="{{url('/export/excel/fg')}}" class="btn btn-success">
				...
				<table class="table table-bordered" id="table">
					...
					<tbody class="text-center">
						...
						<tr>
							...
							<td>{{$x->part_name}}</td> 
							<td>
								{!! QrCode::eye('square')->size(200)->generate('http://http://http://192.168.1.84/stock_barang/public/data/barang/'.$x->id);!!}
						...
						<div class="row">
							<div class="col">
								<div class="mb-3 row">
									...
									<div class="col-sm-10">
										<select class="form-control" id="set_1" style="width: 100%;" name="status">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="text-center">
					{!! QrCode::eye('square')->size(200)->generate('http://192.168.1.84/stock_barang/public/data/barang/'.$p->id);!!}
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
