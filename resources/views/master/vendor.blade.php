...
<div style="margin-top: 150px;">
	<h2 class="text-center">LIST VENDOR</h2>
	<div class="card">
		...
		<div class="table-responsive">
			<div class="card-body">
				...
				<table class="table table-bordered" id="table">
					...
					<thead>
						<tr>
							<th class="text-center">NAME VENDOR</th>
							...
							<td>
								<div class="btn-group" role="group" aria-label="Basic mixed styles example">
									<a href="" class="btn btn-warning text-white" data-bs-toggle="modal" data-bs-target="#edit-{{$x->id}}">
										...
										<a href="{{url('/delete/vendor/'.$x->id)}}" class="btn btn-danger text-white hapus">
	...
	<div class="modal fade" id="edit-{{$p->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="{{url('/update/vendor/'.$p->id)}}" method="post">
				<div class="modal-body">
					@csrf
					<div class="mb-3 row">
						<label for="inputPassword" class="col-sm-2 col-form-label">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="name_vendor" value="{{$p->name_vendor}}">
						</div>
					</div>
				</div>
				<div class="modal-footer">
