...
<div style="margin-top: 150px;">
	<h2 class="text-center">LIST RAK</h2>
	<div class="card">
							...
							<td>
								<div class="btn-group" role="group" aria-label="Basic mixed styles example">
									<a href="" class="btn btn-warning text-white" data-bs-toggle="modal" data-bs-target="#edit-{{$x->id}}">
										...
										<a href="{{url('/delete/rak/'.$x->id)}}" class="btn btn-danger text-white hapus">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Add Rak</h5>

				</div>
				<form action="{{url('/create/rak')}}" method="post">
					<div class="modal-body">
						...
						<div class="mb-3 row">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="name_rak">
							</div>
						</div>
					</div>
	...
	<div class="modal fade" id="edit-{{$p->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="{{url('/update/rak/'.$p->id)}}" method="post">
				<div class="modal-body">
					@csrf
					<div class="mb-3 row">
						<label for="inputPassword" class="col-sm-2 col-form-label">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="name_rak" value="{{$p->name_rak}}">
						</div>
					</div>
				</div>
				<div class="modal-footer">
